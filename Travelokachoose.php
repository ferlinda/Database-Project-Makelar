...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="choose">
    ...
    <form name="property" action="" method="POST" >
      ...
      <input type="submit" name="submit_2" value="Submit" class="button_active" onclick="location.href='/Makelar/Traveloka.php';"/>
    </form>
    </div> 
<!-- END PAGE CONTENT -->
...
if(isset($_POST['submit_2'])){
  ...
  '$_POST[contact]','$_POST[startdate]','$_POST[enddate]','2')");
