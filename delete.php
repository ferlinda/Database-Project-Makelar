...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="newowner">
    ...
    <form name="owner" action="" method="POST" >
      <h1>Building ID to be deleted:</h1><h1><input type="text" name="buildingid" /></h1>
...
<!-- PHP Delete Value, Change Occupancy -->

<?php
if (isset($_POST['submit_1'])){
  $db = pg_connect("host=localhost port=5432 dbname=your-db-name user=your-username password=your-password");
  $result = pg_query($db, "DELETE FROM makelar WHERE buildingid='$_POST[buildingid]'");
  $result = pg_query($db, "UPDATE building SET status='Unoccupied' WHERE buildingid='$_POST[buildingid]'");
  }
